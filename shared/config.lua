...
Config.PenalCode = {
  [1] = {
      ...
      [2] = {title = 'Assault', class = 'Misdemeanor', id = 'P.C. 1002', months = 10, fine = 850, color = 'orange', description = 'If a person intentionally or knowingly causes injury to another (without a weapon)'},
      [3] = {title = 'Aggravated Assault', class = 'Felony', id = 'P.C. 1003', months = 10, fine = 1250, color = 'orange', description = 'When a person unintentionally, and recklessly causes bodily injury to another as a result of a confrontation AND causes bodily injury'},
      [4] = {title = 'Assault with a Deadly Weapon', class = 'Felony', id = 'P.C. 1004', months = 15, fine = 3750, color = 'red', description = 'When a person intentionally, knowingly, or recklessly causes bodily injury to another person AND either causes serious bodily injury or uses or exhibits a deadly weapon'},
      [5] = {title = 'Involuntary Manslaughter', class = 'Felony', id = 'P.C. 1005', months = 30, fine = 7500, color = 'red', description = 'When a person unintentionally and recklessly causes the death of another'},
      [6] = {title = 'Vehicular Manslaughter', class = 'Felony', id = 'P.C. 1006', months = 50, fine = 7500, color = 'red', description = 'When a person unintentionally and recklessly causes the death of anther with a vehicle'},
      [7] = {title = 'Attempted Murder of a Civilian', class = 'Felony', id = 'P.C. 1007', months = 40, fine = 7500, color = 'red', description = 'When a non-government person intentionally attacks another with the intent to kill'},
      [8] = {title = 'Second Degree Murder', class = 'Felony', id = 'P.C. 1008', months = 0, fine = 0, color = 'red', description = 'Any intentional killing that is not premeditated or planned. A situation in which the killer intends only to inflict serious bodily harm.'},
      [9] = {title = 'Accessory to Second Degree Murder', class = 'Felony', id = 'P.C. 1009', months = 0, fine = 0, color = 'red', description = 'Being present and or participating in the act of parent charge'},
      ...
      [13] = {title = 'Attempted Murder of a Public Servant or Peace Officer', class = 'Felony', id = 'P.C. 1013', months = 50, fine = 2000, color = 'red', description = 'Any attacks that are done to a government employee with the intent to cause death. Stacks with every government employee attacked'},
      ...
      [15] = {title = 'Unlawful Imprisonment', class = 'Misdemeanor', id = 'P.C. 1015', months = 5, fine = 600, color = 'green', description = 'The act of taking another against their will and holding them for an extended period of time'},
      [16] = {title = 'Kidnapping', class = 'Felony', id = 'P.C. 1016', months = 10, fine = 900, color = 'orange', description = 'The act of taking another against their will for a short period of time'},
      ...
      [18] = {title = 'Attempted Kidnapping', class = 'Felony', id = 'P.C. 1018', months = 5, fine = 450, color = 'orange', description = 'The act of trying to take someone against their will'},
      [19] = {title = 'Hostage Taking', class = 'Felony', id = 'P.C. 1019', months = 10, fine = 1200, color = 'orange', description = 'The act of taking another against their will for personal gain'},
      [20] = {title = 'Accessory to Hostage Taking', class = 'Felony', id = 'P.C. 1020', months = 5, fine = 600, color = 'orange', description = 'Being present and or participating in the act of parent charge'},
      [21] = {title = 'Unlawful Imprisonment of a Public Servant or Peace Officer.', class = 'Felony', id = 'P.C. 1021', months = 15, fine = 4000, color = 'orange', description = 'The act of taking a government employee against their will for an extended period of time'},
      ...
      [23] = {title = 'Reckless Endangerment', class = 'Misdemeanor', id = 'P.C. 1023', months = 5, fine = 1000, color = 'orange', description = 'The act of disregarding safety of another which may place another in danger of death or bodily injury'},
      [24] = {title = 'Gang Related Shooting', class = 'Felony', id = 'P.C. 1024', months = 15, fine = 2500, color = 'red', description = 'The act in which a firearm is discharged in relation to gang activity'},
      ...
      [26] = {title = 'Torture', class = 'Felony', id = 'P.C. 1026', months = 20, fine = 4500, color = 'red', description = 'The act of causing harm to another to extract information and or for self enjoyment'},
      [27] = {title = 'Medical Terrorism', class = 'Felony', id = 'P.C. 1027', months = 0, fine = 0, color = 'red', description = 'The act of purposefully interfering with the treatment of a wounded, or sick persons often for the intent of killing them through not allowing medical personnel to do their job and/or taking hostage or hurting EMS Personnel whilst they give treatment or on the way to treat a wounded or sick persons'}, 
      [28] = {title = 'Murder of a Judicial official', class = 'Felony', id = 'P.C. 1028', months = 0, fine = 0, color = 'red', description = 'Any intentional killing that is done to a judge, jury member, or attorney that is on duty'}, 
      [29] = {title = 'Attempted Murder of a Judge. Jury Member, or Attorney', class = 'Felony', id = 'P.C. 1029', months = 50, fine = 10000, color = 'red', description = 'Any attacks that are done to a judge, jury member, or attorney on duty with the intent to cause death. Stacks with every judge, Jury Member, or Attorney that is attacked'},
  },
  [2] = {
      ...
      [2] = {title = 'Grand Theft', class = 'Misdemeanor', id = 'P.C. 2002', months = 5, fine = 600, color = 'green', description = 'Theft of property above $700'},
      [3] = {title = 'Grand Theft Auto A', class = 'Felony', id = 'P.C. 2003', months = 10, fine = 900, color = 'green', description = 'The act of stealing a vehicle that belongs to someone else without permission'},
      [4] = {title = 'Grand Theft Auto B', class = 'Felony', id = 'P.C. 2004', months = 25, fine = 3500, color = 'green', description = 'The act of stealing a vehicle that belongs to someone else without permission while armed'},
      [5] = {title = 'Carjacking', class = 'Felony', id = 'P.C. 2005', months = 20, fine = 2000, color = 'orange', description = 'The act of someone forcefully taking a vehicle from its occupants'},
      [6] = {title = 'Burglary', class = 'Misdemeanor', id = 'P.C. 2006', months = 5, fine = 500, color = 'green', description = 'The act of entering into a building illegally with intent to commit a crime, especially theft.'},
      [7] = {title = 'Robbery', class = 'Felony', id = 'P.C. 2007', months = 15, fine = 2000, color = 'green', description = 'The action of taking property unlawfully from a person or place by force or threat of force.'},
      [8] = {title = 'Accessory to Robbery', class = 'Felony', id = 'P.C. 2008', months = 6, fine = 1000, color = 'green', description = 'Being present and or participating in the act of parent charge'},
      [9] = {title = 'Attempted Robbery', class = 'Felony', id = 'P.C. 2009', months = 15, fine = 1000, color = 'green', description = 'The action of attempting property unlawfully from a person or place by force or threat of force.'},
      [10] = {title = 'Armed Robbery', class = 'Felony', id = 'P.C. 2010', months = 15, fine = 3000, color = 'orange', description = 'The action of taking property unlawfully from a person or place by force or threat of force while armed.'},
      [11] = {title = 'Accessory to Armed Robbery', class = 'Felony', id = 'P.C. 2011', months = 10, fine = 1500, color = 'orange', description = 'Being present and or participating in the act of parent charge'},
      [12] = {title = 'Attempted Armed Robbery', class = 'Felony', id = 'P.C. 2012', months = 15, fine = 1500, color = 'orange', description = 'The action of attempting property unlawfully from a person or place by force or threat of force while armed.'},
      [13] = {title = 'Grand Larceny', class = 'Felony', id = 'P.C. 2013', months = 25, fine = 7500, color = 'orange', description = 'Theft of personal property having a value above a legally specified amount.'},
      ...
      [15] = {title = 'Possession of Nonlegal Currency', class = 'Misdemeanor', id = 'P.C. 2015', months = 5, fine = 500, color = 'green', description = 'Being in possession of stolen currency'},
      [16] = {title = 'Possession of Government-Issued Items', class = 'Misdemeanor', id = 'P.C. 2016', months = 10, fine = 1000, color = 'green', description = 'Being in possession of Items only acquireable by government employees'},
      [17] = {title = 'Possession of Items Used in the Commission of a Crime', class = 'Misdemeanor', id = 'P.C. 2017', months = 5, fine = 500, color = 'green', description = 'Being in possession of Items that were previously used to commit crimes'},
      [18] = {title = 'Sale of Items Used in the Commission of a Crime', class = 'Felony', id = 'P.C. 2018', months = 10, fine = 1000, color = 'orange', description = 'The act of selling items that were previously used to commit crimes'},
      [19] = {title = 'Theft of an Aircraft', class = 'Felony', id = 'P.C. 2019', months = 10, fine = 1000, color = 'green', description = 'The act of stealing an aircraft'},
      [20] = {title = 'Ownership of a Chop Shop', class = 'Felony', id = 'P.C. 2020', months = 150, fine = 10000, color = 'red', description = 'The ownership of a property on which one or more people partake in the business of receiving, concealing, destroying, or dismantling an unlawfully obtained vehicle'},
  },
  [3] = {
      [1] = {title = 'Impersonating', class = 'Misdemeanor', id = 'P.C. 3001', months = 10, fine = 1250, color = 'green', description = 'The action of falsely identifying as another person to deceive'},
      [2] = {title = 'Impersonating a Peace Officer or Public Servant', class = 'Felony', id = 'P.C. 3002', months = 15, fine = 2750, color = 'green', description = 'The action of falsely identifying as a government employee to deceive'},
      ...
      [4] = {title = 'Possession of Stolen Identification', class = 'Misdemeanor', id = 'P.C. 3004', months = 10, fine = 500, color = 'green', description = 'To have another persons Identification without consent'},
      [5] = {title = 'Possession of Stolen Government Identification', class = 'Misdemeanor', id = 'P.C. 3005', months = 10, fine = 2000, color = 'green', description = 'To have the identification of a government employee without consent'},
      [6] = {title = 'Extortion', class = 'Felony', id = 'P.C. 3006', months = 10, fine = 900, color = 'orange', description = 'To threaten or cause harm to a person or property for financial gain'},
      [7] = {title = 'Fraud', class = 'Misdemeanor', id = 'P.C. 3007', months = 5, fine = 450, color = 'green', description = 'To deceive another for financial gain'},
      [8] = {title = 'Forgery', class = 'Misdemeanor', id = 'P.C. 3008', months = 10, fine = 750, color = 'green', description = 'To falsify legal documentation for personal gain'},
      ...
      [10] = {title = 'Possession of a government firearm ', class = 'Felony', id = 'P.C. 3010', months = 50, fine = 5000, color = 'red', description = 'The possession of a firearm distributed to a government employee without permission from the government and the employee the firearm was distributed to'},

  },
  [4] = {
      [1] = {title = 'Trespassing', class = 'Misdemeanor', id = 'P.C. 4001', months = 5, fine = 450, color = 'green', description = 'For a person to be within the bounds of a location of which they are not legally allowed'},
      [2] = {title = 'Felony Trespassing', class = 'Felony', id = 'P.C. 4002', months = 10, fine = 1500, color = 'green', description = 'For a person to have repeatedly entered the bounds of a location of which they are knowingly not legally allowed'},
      [3] = {title = 'Arson', class = 'Felony', id = 'P.C. 4003', months = 10, fine = 1500, color = 'orange', description = 'The use if fire and accelerants to will and maliciously destroy, harm or cause death to a person or property'},
      ...
      [5] = {title = 'Vandalism of Government Property', class = 'Felony', id = 'P.C. 4005', months = 10, fine = 1500, color = 'green', description = 'The willful destruction of government property'},
  ...
  [5] = {
      ...
      [3] = {title = 'Possession of Contraband in a Government Facility', class = 'Felony', id = 'P.C. 5003', months = 15, fine = 1000, color = 'green', description = 'Being in possession of items that are illegal while within a government building'},
      ...
      [6] = {title = 'Jailbreak', class = 'Felony', id = 'P.C. 5006', months = 15, fine = 2500, color = 'orange', description = 'The action of leaving state custody from a state or county detention facility'},
      [7] = {title = 'Accessory to Jailbreak', class = 'Felony', id = 'P.C. 5007', months = 15, fine = 2000, color = 'orange', description = 'Being present and or participating in the act of parent charge'},
      [8] = {title = 'Attempted Jailbreak', class = 'Felony', id = 'P.C. 5008', months = 10, fine = 1500, color = 'orange', description = 'The willful and intentional attempted escape from a state or county detention facility'},
      ...
      [10] = {title = 'Violation of a Restraining Order', class = 'Felony', id = 'P.C. 5010', months = 10, fine = 2250, color = 'green', description = 'The willful and knowing infringement upon court ordered protective documentation'},
      [11] = {title = 'Embezzlement', class = 'Felony', id = 'P.C. 5011', months = 25, fine = 10000, color = 'green', description = 'The willful and knowingly movement of funds from non personal bank accounts to personal bank accounts for personal gain'},
      [12] = {title = 'Unlawful Practice', class = 'Felony', id = 'P.C. 5012', months = 10, fine = 1500, color = 'orange', description = 'The action of performing a service without proper legal licensing and approval'},
      ...
      [19] = {title = 'Possession of Hacking Materials', class = 'Felony', id = 'P.C. 5019', months = 10, fine = 500, color = 'orange', description = 'The possession of items used in hacking including but not limited to Trojan USBs and Electronic Kits'},
      [20] = {title = 'Possession of Explosive Materials', class = 'Felony', id = 'P.C. 5020', months = 20, fine = 1000, color = 'red', description = 'The possession of illegal items that explosive including but not limited to Thermite, Rocket Ammunition, and Grenades'},
      [21] = {title = 'Possession of Stolen Key Cards', class = 'Felony', id = 'P.C. 5021', months = 15, fine = 750, color = 'orange', description = 'The possession of stolen key cards including Security Card A and B'},
  },
  [6] = {
      ...
      [7] = {title = 'Felony Obstruction of Justice', class = 'Felony', id = 'P.C. 6007', months = 10, fine = 900, color = 'green', description = 'Acting in a way that hinders the process of Justice or lawful investigations while using violence'},
      [8] = {title = 'Inciting a Riot', class = 'Felony', id = 'P.C. 6008', months = 15, fine = 1000, color = 'orange', description = 'Causing civil unrest in a manner to incite a group to cause harm to people or property'},
      ...
      [11] = {title = 'Vehicle Tampering', class = 'Misdemeanor', id = 'P.C. 6011', months = 10, fine = 750, color = 'green', description = 'The willful and knowing interference the normal function of a vehicle'},
      ...
      [14] = {title = 'Failure to Provide Identification', class = 'Misdemeanor', id = 'P.C. 6014', months = 10, fine = 1500, color = 'green', description = 'The act of not presenting identification when lawfully required to do so'},
      [15] = {title = 'Vigilantism', class = 'Felony', id = 'P.C. 6015', months = 15, fine = 1500, color = 'orange', description = 'The act of engaging in enforcing the law with legal authority to do so'},
      ...
      [18] = {title = 'Stalking', class = 'Felony', id = 'P.C. 6018', months = 20, fine = 1500, color = 'orange', description = 'When one person monitors another without their consent'},
      [19] = {title = 'Aiding and Abetting', class = 'Misdemeanor', id = 'P.C. 6019', months = 10, fine = 450, color = 'orange', description = 'To assist someone in committing or to encourage someone to commit a crime'},
      [20] = {title = 'Harboring a Fugitive', class = 'Misdemeanor', id = 'P.C. 6020', months = 5, fine = 1000, color = 'green', description = 'When someone willingly hides another who is wanted by the authorities'},
      [21] = {title = 'Terrorism', class = 'Felony', id = 'P.C. 6021', months = 0, fine = 0, color = 'red', description = 'The act of kidnapping of a commissioner of police, mayor, or any political figure, and/or the murder of a public official, political figure, or commissioner of police. Or. The act of using violence, threats, or the threat/commiting of extreme injury against any people based on religion, race, gender identity, or any other discriminating factor on a large scale often using militant tactics to instate mass fear in a public. Or. Bombing or using extreme violence for the main purpose of destabilizing a government, or for political gain or in the name of a political organization.'},
  },
  [7] = {
  ...
  [8] = {
      ...
      [4] = {title = 'Criminal Possession of Weapon Class D', class = 'Felony', id = 'P.C. 8004', months = 50, fine = 1500, color = 'green', description = 'Possession of a Class D firearm without licensing'},
      ...
      [8] = {title = 'Criminal Sale of Weapon Class D', class = 'Felony', id = 'P.C. 8008', months = 50, fine = 3000, color = 'orange', description = 'The act of selling a Class D firearm without licensing'},
      ...
      [17] = {title = 'Criminal Firearm Manufacturing', class = 'Felony', id = 'P.C. 8017', months = 250, fine = 10000, color = 'red', description = 'The manufacturing of firearms without the proper license or the owning of a gun workshop/factory without proper license'},
      [18] = {title = 'Felony Jaywalking', class = 'Felony', id = 'P.C. 8018', months = 25, fine = 300, color = 'green', description = 'crossing a roadway in a manner that is hazardous to motor vehicles repeatedly after being told to stop or with many previous Jaywalking charges in criminal history'},
  },
  [9] = {
      ...
      [22] = {title = 'Piloting without Proper Licensing', class = 'Felony', id = 'P.C. 9022', months = 10, fine = 1500, color = 'orange', description = 'Failure to be in possession of valid licensing when operating an aircraft'},
  ...
  [10] = {
      [1] = {title = 'Hunting in Restricted Areas', class = 'Infraction', id = 'P.C. 10001', months = 10, fine = 450, color = 'green', description = 'Harvesting game in areas where it is prohibited to do so'},
      [2] = {title = 'Unlicensed Hunting', class = 'Infraction', id = 'P.C. 10002', months = 25, fine = 4500, color = 'green', description = 'Harvesting game without proper licensing'},
      [3] = {title = 'Animal Cruelty', class = 'Misdemeanor', id = 'P.C. 10003', months = 50, fine = 5000, color = 'green', description = 'The act of abusing an animal knowingly or not'},
      ...
      [5] = {title = 'Hunting outside of hunting hours', class = 'Infraction', id = 'P.C. 10005', months = 10, fine = 750, color = 'green', description = 'Harvesting animals outside of specified time to do so'},
      ...
      [7] = {title = 'Poaching', class = 'Felony', id = 'P.C. 10007', months = 50, fine = 5000, color = 'red', description = 'Harvesting an animal that is listed as legally non-harvestable'},
  }
}
